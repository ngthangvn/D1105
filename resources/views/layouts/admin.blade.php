...
<head>
    ...
    <link rel="icon" href=" {{ asset('public/admin/assets/img/kaiadmin/favicon.ico') }} " type="image/x-icon" />
            ...
            <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                    <a href="index.html" class="logo">
                        <img src=" {{ asset('public/admin/assets/img/kaiadmin/logo_light.svg') }} " alt="navbar brand" class="navbar-brand"
                            height="20" />
                    </a>
            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-item {{ request()->routeIs('product.*') ? 'active submenu' : '' }}">
                            ...
                            <div class="collapse {{ request()->routeIs('product.*') ? 'show': '' }}" id="sidebarLayouts">
                                <ul class="nav nav-collapse">
                                    <li {{ request()->routeIs('product.*') ? 'active' : '' }}>
                        ...
                        <li class="nav-item" {{ request()->routeIs('category.*') ? 'active submenu' : '' }}>
                            <a data-bs-toggle="collapse" href="#forms">
                                <i class="fas fa-pen-square"></i>
                                <p>Quản lý danh mục</p>
                                <span class="caret"></span>
                            </a>
                            <div class="collapse {{ request()->routeIs('category.*') ? 'show': '' }}" id="forms">
                                <ul class="nav nav-collapse">
                                    <li>
                                    ...
                                    <li>
                                        <div class="message-notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src=" {{ asset('public/admin/assets/img/jm_denis.jpg') }} " alt="Img Profile" />
                                                    </div>
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src=" {{ asset('public/admin/assets/img/chadengle.jpg') }} " alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src=" {{ asset('public/admin/assets/img/mlane.jpg') }} " alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src=" {{ asset('public/admin/assets/img/talha.jpg') }} " alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                    ...
                                    <li>
                                        <div class="notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src=" {{ asset('public/admin/assets/img/profile2.jpg') }} " alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                        <span class="block">
