        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    <h3 class="h2 py-3">Sản phẩm nổi bật</h3>
                    {{-- @dd($products) --}}
                    @php
                        $count = 0;
                    @endphp
                    ...
                    {{-- hiện danh sách phẩm theo category --}}


                    @foreach ($category as $categories)
                        @unless ($categories->products->isEmpty())
                            <div class="d-flex bd-highlight mb-3">
                                <h3 class="p-2 bd-highlight h2 py-3">{{ $categories->name }}</h3>
                                <a href="{{ route('getProductByCategory', $categories->id) }}" class="ms-auto p-2 bd-highlight">Xem thêm</a>
                            </div>
                            {{-- @dd($categories->products) --}}
                            @foreach ($categories->products->take(3) as $product)
                                <div class="col-md-4">
                                    <div class="widget2-top card mb-4 product-wap rounded-0">
                                        <div class="card rounded-0">
                                            <img class="card-img rounded-0 img-fluid" src="{{ $product->image }}">
                                            <div
                                                class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
